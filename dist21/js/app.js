(() => {
      ...
      if (
        ...
        if (0 === t) r[e ? "scrollLeft" : "scrollTop"] = -c;
          ...
          if (!l.support.smoothScroll)
            return (
              O({ swiper: l, targetPosition: -c, side: e ? "left" : "top" }), !0
            );
  ...
  const F = {
    slideTo: function (e, t, s, i, n) {
      ...
      if ((l.animating && r.preventInteractionOnTransition) || (!f && !i && !n))
        return !1;
      const m = Math.min(l.params.slidesPerGroupSkip, a);
      let g = m + Math.floor((a - m) / l.params.slidesPerGroup);
    ...
    s({
      ...
      i("click", (e, s) => {
        const { $nextEl: i, $prevEl: l } = t.navigation,
          a = s.target;
        if (t.params.navigation.hideOnClick && !E(a).is(l) && !E(a).is(i)) {
          if (
            t.pagination &&
            t.params.pagination &&
      ...
      Object.assign(t.navigation, { update: r, init: c, destroy: p });
  }
  function ue(e) {
    return (
      void 0 === e && (e = ""),
  ...
  function he(e) {
    ...
    function c() {
      ...
      if (
        ("fraction" === s.type &&
          (l.find(ue(s.currentClass)).text(s.formatFractionCurrent(c + 1)),
          l.find(ue(s.totalClass)).text(s.formatFractionTotal(p))),
        "progressbar" === s.type)
      ) {
        let e;
    ...
    function p() {
      ...
      if ("bullets" === e.type) {
        ...
        i.html(l), (t.pagination.bullets = i.find(ue(e.bulletClass)));
      }
      "fraction" === e.type &&
        ((l = e.renderFraction
      ...
      setTransition: (e) => {
        ...
        (s ? t.slides.find(s) : t.slides).transition(e),
          (function (e) {
            ...
            const { slides: l, activeIndex: a, $wrapperEl: r } = t;
            if (t.params.virtualTranslate && 0 !== s) {
              let e,
                s = !1;
              (e = n ? (i ? l.find(i) : l) : i ? l.eq(a).find(i) : l.eq(a)),
                e.transitionEnd(() => {
                  if (s) return;
